...
<section class="p-slide">
  <h2 class="p-slide__title">
    <span class="p-slide__title-box">後悔しないキャリアを作る、</span>
    <span class="p-slide__title-box">それこそが、我々の使命だ</span>
  </h2>
  <div class="p-slide__inner" style="--_img-count: <?php echo esc_attr($img_count); ?>;">
    <?php for ($i = 0; $i < 2; $i++):
