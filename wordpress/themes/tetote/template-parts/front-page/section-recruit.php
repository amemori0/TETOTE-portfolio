<section class="p-top-recruit">
  <div class="l-inner">
    <h2 class="c-section-title" data-align="center">
      <span class="c-section-title--ja">採用情報</span>
      <span lang="en" aria-hidden="true" class="c-section-title--en">Recruitment</span>
    </h2>
    <p class="p-top-recruit__text">募集要項（職種、業務内容、応募条件、選考フロー）とよくある質問・会社概要などをまとめています。</p>
